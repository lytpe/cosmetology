#pragma checksum "D:\Cosmetology\Views\ManageContent\Update.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "87725ec9c2916398fc2d0d60224e55e20101147d"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"87725ec9c2916398fc2d0d60224e55e20101147d", @"/Views/ManageContent/Update.cshtml")]
...
<script>
       $table=$(""#listtable"");
		 $table.bootstrapTable({
            ...
            sidePagination:""ser");
            WriteLiteral(@"ver"",           //分页方式：client客户端分页，server服务端分页（*）
            ...
            columns: [
               ...
               ");
            WriteLiteral(@" field: 'updateContent',
                title: '更新内容',
    ...
    $(""#delete"").click(function(){
        var ids=$.map($table.bootstrapTable('getSele");
            WriteLiteral(@"ctions'),function(row){return row.id});
        if (ids.length != 1 ) {
            alert(""请选择一行删除!"");
            return;
        }
