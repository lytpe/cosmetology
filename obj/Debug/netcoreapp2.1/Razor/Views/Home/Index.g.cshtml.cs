#pragma checksum "d:\Cosmetology\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d3e410ee915782dfb25ac7f13a009f449d5016c9"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d3e410ee915782dfb25ac7f13a009f449d5016c9", @"/Views/Home/Index.cshtml")]
...
<script>
	...
	$.ajax({
		...
		success:function(data, textStatus){
			...
			var htm="""";
			for(var i=0;i<articles.length;i++){
				htm+=""<div class='events-g");
            WriteLiteral("rid1-right\'><h4><a asp-controller=\'Home\' asp-action=\'Single\'>\"+articles[i].articleName+\"</a></h4><p>\"+articles[i].articleSideName+\"</p></div>\";\n\t\t\t}\n\t\t\t$(\"#articlelists\").append(htm);\n\t\t},\n\t\terror:function(){\n\t\t\tconsole.log(\"请求失败！\");\n\t\t}\n\t});\n</script>");
            EndContext();
        }
