#pragma checksum "D:\Cosmetology\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0f8f5ab1c5637fb61b51f8fd4324ac44294a3a26"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0f8f5ab1c5637fb61b51f8fd4324ac44294a3a26", @"/Views/Home/Index.cshtml")]
...
<script>
	...
	$.ajax({
		...
		success:function(data, textStatus){
			...
			");
            WriteLiteral(@"$(""#IndexArticles"").append(htm);
		},
		error:function(){
			console.log(""请求失败！"");
		}
	...
	$.ajax({
		...
		success:function(data, textStatus){
			...
			var htm="""";
			for(var i=0;i<articles.length;i++){
				htm+=""<div class='events-grid1-right'><h4><a a");
            WriteLiteral("sp-controller=\'Home\' asp-action=\'Single\'>\"+articles[i].articleName+\"</a></h4><p>\"+articles[i].articleSideName+\"</p></div>\";\n\t\t\t}\n\t\t\t$(\"#articlelists\").append(htm);\n\t\t},\n\t\terror:function(){\n\t\t\tconsole.log(\"请求失败！\");\n\t\t}\n\t});\n</script>");
            EndContext();
        }
