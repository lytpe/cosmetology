#pragma checksum "D:\Cosmetology\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "66f4903e3acb5459dd33042b802d64d788c7ca89"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"66f4903e3acb5459dd33042b802d64d788c7ca89", @"/Views/Home/Index.cshtml")]
...
<script>
	$.ajax({
	");
            WriteLiteral(@"	url:'/cos/Home/showBigPic',
		type:'POST',
		dataType:'Json',
	...
	$.ajax({
		url:'/cos/Home/showIndexModelOne',
		type:'POST',
		dataType:'Json',
		contentType:""application/json"",
		success:function(data, textStatus){
			...
			for(var i=0;i<articles.length;i++){
				htm+=""<div class='col-sm-6 col-md-3 col-lg-3'><div class='banner-bottom-grid1'><h1>""+articles[i].articleName+""</h1><p>""+articles[i].articleSideName+""</p><div class='more'><a href='/cos/Home/Single?id=""+articles[i].id+""' class='hvr-cur");
            WriteLiteral(@"l-bottom-right'>Read More...</a></div></div></div>"";
			}
	...
	$.ajax({
		url:'/cos/Home/showIndexModelTwo',
		type:'POST',
		dataType:'Json',
		contentType:""application/json"",
		success:function(data, textStatus){
	...
	$.ajax({
		url:'/cos/Home/showIndexModelThree',
		type:'POST',
		dataType:'Json',
		contentType:""application/json"",
		success:function(data, textStatus){
			...
			var htm="""";
			for(var i=0;i<a");
            WriteLiteral(@"rticles.length;i++){
				htm+=""<div class='events-grid1-right'><h4><a asp-controller='Home' asp-action='Single'>""+articles[i].articleName+""</a></h4><p>""+articles[i].articleSideName+""</p></div>"";
			}
